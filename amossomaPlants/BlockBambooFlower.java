...
public class BlockBambooFlower extends BlockCrops implements IPlantable
{
	protected BlockBambooFlower(int par1, int par2)
    {
        super(par1, par2);
    ...
    {
        return AmossomaPlants.bambooseeds.itemID;
    }
