...
public class BlockCottonFlower extends BlockCrops implements IPlantable
{
	protected BlockCottonFlower(int par1, int par2)
    {
        super(par1, par2);
    ...
    {
        return AmossomaPlants.cottonseeds.itemID;
    }
