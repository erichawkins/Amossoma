...
public class BlockcottonCushion extends BlockMountable
{
	
	public BlockcottonCushion(int par1, int par2)
    {
    ...
    {
    	return BlockMountable.onBlockActivated(world, i, j, k, 	entityplayer, .50F);
    }
   /**
