...
public class BlockYellowAlgaeBlock extends BlockCrops
{
    ...
    public BlockYellowAlgaeBlock(int par1, int par2)
    {
        super(par1, par2);
        float var3 = 0.5F;
      ...
      */
    		public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    		{
    			if (!par1World.isRemote)
    			{
    				...
    				if (AmossomaWaterPhysics.CanFloatAbove(par1World, par2, par3 + 1, par4, this.GetBlockMaxHeight()))
    				{
