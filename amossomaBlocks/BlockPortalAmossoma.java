...
import amossomaDimension.AmossomaDimesion;
import amossomaDimension.TeleporterAmossoma;
...
public class BlockPortalAmossoma extends BlockPortal
{
	public BlockPortalAmossoma(int id, int texture)
	{
		super(id, texture);
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
	{
		if (par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null)
		{
			if (par5Entity instanceof EntityPlayerMP)
			{
				...
				if (par5Entity.dimension != AmossomaDimesion.dimension)
				{
					thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, AmossomaDimesion.dimension, new TeleporterAmossoma(thePlayer.mcServer.worldServerForDimension(AmossomaDimesion.dimension)));
				}
				else
				{
					thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterAmossoma(thePlayer.mcServer.worldServerForDimension(0)));
				}
			}
		}
	}
